...
- **Remaining work:**
   ...
   - Phase 9 (remaining): Remove old entity_trait macros, state infrastructure; migrate remaining integration test entities (KVStore, WorkflowTest, ActivityTest, TraitTest, TimerTest, CrossEntity, SqlActivityTest) in examples/cluster-tests to new API; migrate chess-cluster entities; delete UI compile-fail tests for removed features once old codegen is removed
